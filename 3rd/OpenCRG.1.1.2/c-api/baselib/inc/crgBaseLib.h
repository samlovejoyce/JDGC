...
#define dCrgCpOptionBorderModeV          2       /* [integer], extrapolation / repeat mode for z values in v direction    [dCrgBorderModexxx] */
#define dCrgCpOptionCurvMode             3       /* [integer], curvature calculation mode aside the reference line              [dCrgCurvxxx] */
#define dCrgCpOptionBorderOffsetU        5       /* [double],  offset of z values when exceeding core area in u direction                 [m] */
#define dCrgCpOptionBorderOffsetV        6       /* [double],  offset of z values when exceeding core area in v direction                 [m] */
#define dCrgCpOptionSmoothUBegin         7       /* [double],  smoothly blend the data on-set over the given range                            */
/*            at the begin of the data set                                               [m] */
#define dCrgCpOptionSmoothUEnd           8       /* [double],  smoothly blend the data off-set over the given range                           */
												 /*            at the end of the data set                                                 [m] */
#define dCrgCpOptionRefLineSearchU       9       /* [double],  pre-load history with given u value for search of                              */
												 /*            reference line                                                             [m] */
#define dCrgCpOptionRefLineSearchUFrac  10       /* [double],  pre-load history with given relative u value for search                        */
												 /*            of reference line                                                          [-] */
